...
function E(k::AbstractVector{<:Real},t::Real,μ::Real,Δ_kwargs...) 
    Δ_kwargs = (Δ_kwargs[1],k,Δ_kwargs[2:end]...) # match input format of Δ
    return sqrt(ξ(k,t,μ)^2 + abs(Δ(Δ_kwargs...))^2)
end
